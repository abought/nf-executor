...
import abc_impute.api.enums
import abc_impute.api.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_storage_root', models.CharField(blank=True, help_text='Location (relative to storage root) for job-specific files that are retained after job is completed.', max_length=256, null=True)),
                ('owner', models.CharField(db_index=True, help_text='eg User ID provided by an external service. Must not be mutable (username or ID, not email)', max_length=100)),
                ...
                ('status', models.IntegerField(choices=[(10, 'started'), (40, 'completed'), (50, 'error'), (0, 'submitted'), (20, 'cancel_pending'), (25, 'unknown'), (30, 'canceled')], default=abc_impute.api.enums.JobStatus['submitted'])),
                ('expire_on', models.DateTimeField(default=abc_impute.api.models._future_date, help_text='30 days after submission OR 7 days after completion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'NEW'), (10, 'SUBMITTED'), (20, 'RUNNING'), (30, 'ABORTED'), (40, 'FAILED'), (50, 'COMPLETED')], default=abc_impute.api.enums.TaskStatus['SUBMITTED'])),
