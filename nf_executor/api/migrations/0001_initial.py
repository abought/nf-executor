    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(10, 'started'), (40, 'error'), (50, 'completed'), (0, 'submitted'), (20, 'cancel_pending'), (25, 'unknown'), (30, 'canceled')], default=nf_executor.api.enums.JobStatus['submitted'])),
