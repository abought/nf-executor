# Generated by Django 4.2.3 on 2023-09-22 21:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(db_index=True, help_text='Does this workflow accept new jobs? Set to false to disable. Existing jobs will be allowed to complete.')),
            ],
        ),
